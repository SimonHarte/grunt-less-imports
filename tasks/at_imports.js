...
module.exports = function(grunt) {
	...
	grunt.registerMultiTask('at_imports', 'A grunt task to create @import statements from a collection of stylesheet files.', function() {

		// Merge task-specific and/or target-specific options with these defaults.
		var options = this.options({
			inlineCSS: true,
			banner: '// This file was generated by grunt-at-imports',
			import: 'once',
			type: 'less'
		});
